    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="./assets/02/1.jpg" class="d-block w-100" alt="">
                      </div>
                      <div class="carousel-item">
                        <img src="./assets/02/2.jpg" class="d-block w-100" alt="">
                      </div>
                      <div class="carousel-item">
                        <img src="./assets/02/3.jpg" class="d-block w-100" alt="">
                      </div>
                      <div class="carousel-item">
                        <img src="./assets/02/4.jpg" class="d-block w-100" alt="">
                      </div>
                      <div class="carousel-item">
                        <img src="./assets/02/5.jpg" class="d-block w-100" alt="">
                      </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <h2>God Enel</h2>
                <p class="price">34,800 THB</p>
                <p><b>ขนาด:</b> W52 D52 H62 cm</p>
                <p><b>Scale:</b> 1:5</p>
                <p><b>มัดจำ:</b> 12,000 THB</p>
